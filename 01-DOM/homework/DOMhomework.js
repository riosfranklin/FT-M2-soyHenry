...
createdBy.innerHTML = createdBy.innerHTML + " Lucas Magra";
...
function buildToDo(todo, index) {
  ...
  toDoShell.className = "toDoShell" /// toDoShell.classList.add("toDoShell") agregarle una clase, en caso que ya tenga definidas ( <div class="toDoShell"> </div> )
  ...
  if(todo.complete){
    toDoText.className = "completeText" /// toDoShell.classList.add("completeText") ( <div class="toDoShell completeText"> </div> )
  }
...
function buildToDos(toDos) {
  // Tu código acá:
  const shellsArray = toDos.map(function(x, y){ // recibimos un array de toDos y creamos un toDoShell por cada elemento de ese array;
    return buildToDo(x, y);
  })
  return shellsArray;
}
...
function completeToDo(event) {
  ...
  // Tu código acá:
  toDoItems.at(index).completeToDo(); // en toDoItems[index] ejecutar completeToDo
